...
async execute (client, message, args){
  ...
  if(!args[0]) return message.channel.send("**<:x_:1030676024662442065> |  Debes elejir: | `piedra`, `papel` o `tijera` <:x_:1030676024662442065>**")
  
  let Options = ["piedra", "papel", "tijera"]

  if(!Options.includes(args[0].toLowerCase())) return message.channel.send("**<:x_:1030676024662442065> |  Debes elejir: | `piedra`, `papel` o `tijera` <:x_:1030676024662442065>**")
